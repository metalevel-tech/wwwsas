...
````bash
cd /etc
sudo git clone https://github.com/metalevel-tech/www-security-assistant.git
````
...
````bash
sudo git clone https://github.com/metalevel-tech/www-security-assistant.git /etc/wwwsas
````
...
* `$1` - `branch` of `https://github.com/metalevel-tech/www-security-assistant` (default: master).
...
15. **Setup Ipset SAVE and RESTORE at REBOOT**. This step is similar as the above, but it will be processed, if you have run the `SETUP` script with the [`full-access`](https://github.com/metalevel-tech/www-security-assistant#step-2--setup-www-security-assistant) option enabled. Currently the tool `ipset` is used within the script `iptables.basic-setup.local` to be created a [real port scanning protection](https://unix.stackexchange.com/a/407904/201297).
...
---
**Please keep reading. The rest of this tutorial is about the integration of the script `www-security-assistant.bash` and the whole system. More verbose explanations could be found in the file [README.OLD.md](https://github.com/metalevel-tech/www-security-assistant/blob/stable.v.2/README.OLD.md).**
...
* [Common Apache's Security Tips][1]
  ...
  [2]: https://github.com/metalevel-tech/www-security-assistant/blob/master/www-security-assistant.bash
  ...
  [40]: https://github.com/metalevel-tech/www-security-assistant/blob/master/modsecurity-assistant.bash
  ...
  [52]: https://github.com/metalevel-tech/www-security-assistant/blob/master/httpd-guardian.pl
  ...
  [64]: https://github.com/metalevel-tech/www-security-assistant/blob/master/httpd-custom-analyze.bash
