...
- The script needs a minimal configuration to send emails:
  ...
  If there is any configured HTTPS service its [TLS certificate can be used within the Postfix service][5].
...
- Create work directory, let's call it `/var/www-security-assistant`. Download **`www-security-assistant.bash`** and make it executable:
    ...
    ````
  **Of course if you want you can clone the GitHub repository.**
...
- To make the things more *fun* place the script [`issues.php`](https://github.com/pa4080/www-security-assistant/blob/ask_ubuntu/appendix/var/www/html/issues.php) in an appropriate location within your `DocumentRoot` (here I'm assuming this place is `/var/www/html`):
...
Download [`httpd-custom-analyze.bash`](https://github.com/pa4080/www-security-assistant/blob/ask_ubuntu/httpd-custom-analyze.bash) and make it executable:
...
- [Common Apache's Security Tips][1]
  ...
  [2]: https://github.com/pa4080/www-security-assistant/blob/ask_ubuntu/www-security-assistant.bash
  ...
  [40]: https://github.com/pa4080/www-security-assistant/blob/ask_ubuntu/modsecurity-assistant.sh
  ...
  [52]: https://github.com/pa4080/www-security-assistant/blob/ask_ubuntu/httpd-guardian.pl
  ...
  [64]: https://github.com/pa4080/www-security-assistant/blob/ask_ubuntu/httpd-custom-analyze.bash
