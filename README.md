...
19. [**WWWSAS AbuseIPDB Integration** ► WWWSAS ► Iptables](#wwwsas-abuseipdb-integration--wwwsas--iptables)
20. [HTTPS and Common Apache Security Tips](#https-and-common-apache-security-tips)
...
* `$AbuseIPDB_LIMIT_RECORDS_NUMBER`, default: `'15'`
* `AbuseIPDB_LIMIT_ABUSESCORE`, default: `'15'`
* `AbuseIPDB_LIMIT_CATEGORY_COUNT`, default: `'5'`
