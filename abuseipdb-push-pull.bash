...
# $AbuseIPDB_APIKEY
# $AbuseIPDB_LIMIT_RECORDS_NUMBER
# $AbuseIPDB_LIMIT_ABUSESCORE
#
...
then
    ...
    echo "Category Count: $AbuseIPDB_IP_CATEGORY_COUNT (Limit: $AbuseIPDB_LIMIT_CATEGORY_COUNT)"
    ...
    echo "Abuse Score:    $AbuseIPDB_IP_ABUSESCORE (Limit: $AbuseIPDB_LIMIT_ABUSESCORE)"
    echo "Records Number: $AbuseIPDB_IP_RECORDS_NUMBER (Limit: $AbuseIPDB_LIMIT_RECORDS_NUMBER)"
...
then
    ...
    echo "Is Whitelisted: $AbuseIPDB_IP_ISWHITELISTED"
    echo "Category Count: <b>$AbuseIPDB_IP_CATEGORY_COUNT</b> (Limit: $AbuseIPDB_LIMIT_CATEGORY_COUNT)"
    echo "Abuse Score:    <b>$AbuseIPDB_IP_ABUSESCORE</b> (Limit: $AbuseIPDB_LIMIT_ABUSESCORE)"
    echo "Records Number: <b>$AbuseIPDB_IP_RECORDS_NUMBER</b> (Limit: $AbuseIPDB_LIMIT_RECORDS_NUMBER)"
elif [[ $ACTION_TYPE == 'analyse-ip' ]]
then
    pull_ip_data
    if [[ $AbuseIPDB_IP_RECORDS_NUMBER -ge "$AbuseIPDB_LIMIT_RECORDS_NUMBER" || $AbuseIPDB_IP_ABUSESCORE -ge "$AbuseIPDB_LIMIT_ABUSESCORE" || $AbuseIPDB_IP_CATEGORY_COUNT -ge "$AbuseIPDB_LIMIT_CATEGORY_COUNT" ]] 
    then
        echo 'Bad Guy'
    else
        echo "Records Number: $AbuseIPDB_IP_RECORDS_NUMBER (Limit: $AbuseIPDB_LIMIT_RECORDS_NUMBER)"
