...
#
#     This script is retributed under the same conditions as part of my hobby project WWW Security Assistant (https://github.com/metalevel-tech/www-security-assistant)
...
#        
#     To configure ModSecurity to work with this script, without using 'www-security-assistant.bash' (Iptables chain WWWSAS is required):
