...
# Name:    modules/abuseipdb-push-pull.sh
...
# ACTION_TYPE='analyse-ip'        - outputs the AbuseScore index only, mainly used by 'wwwsas.sh'.
# ACTION_TYPE='push-ip-data'      - outputs the number of AbuseScore records only, mainly used by 'wwwsas.sh'.
