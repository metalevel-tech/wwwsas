...
# - Default mode, that will outut the result in CLI: '/path/to/flood-detector.bash' or 'wwwsas-fd'
# - AutoMode, that should be used in Root`s Crontab: '* * * * * "/path/to/flood-detector.bash" 'AutoMode' >> "/path/to/tmp/www-security-assistant.exec.log" 2>&1'
